...
# Define Pages 1 to 10 for Martdia
PAGES_CONTENT = {}
...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 7.8pt;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>مساهمة طوخ الأقلام (محمد وليد الباز) وميت خميس (أحمد مبروك) المجانية.</td>
        </tr>
        <tr>
...
• <strong>التواجد الميداني المطلق والمستمر لـ محمد وليد الباز:</strong> يلتزم الشريك <strong>محمد وليد الباز</strong> بالتواجد اليومي والمستمر في مستودع طوخ الأقلام وتولى مهام الإدارة الفورية، مستفيداً من شبكة علاقاته المحلية بالمنطقة لبناء الثقة الفورية مع البقالات ومحلات السوبرماركت.</p>
...
<p>• <strong>الدعم الإيجاري والتشغيلي المجاني:</strong> لخفض النفقات الثابتة خلال مرحلة الانطلاق الحساسة، يتبرع الشريك <strong>محمد وليد الباز</strong> بتوفير المستودع مجاناً بالكامل دون أي قيمة إيجارية طوال الستة أشهر الأولى للنشاط، كإسهام عيني تأسيسي منه لدعم الشركة وتسريع انطلاقها.<br>
...
<table style="width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 7.8pt;">
    ...
    <tbody>
        <tr>
            ...
            <td>150 متر مربع</td>
            <td><strong>مجاناً بالكامل طوال 6 أشهر الأولى</strong> (مساهمة محمد وليد الباز)</td>
