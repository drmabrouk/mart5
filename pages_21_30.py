...
def get_master_agreement_page_wrapper(page_index, total_pages, title_ar, body_html, show_continuation=True):
    ...
    <div style="display: grid; grid-template-columns: repeat(4, 1fr) 60px; gap: 8px; margin-top: 10px; border-top: 1.5px solid #1a1a1a; padding-top: 8px; font-family: 'Cairo', sans-serif;">
        <div style="border: 1px dashed #cbd5e1; padding: 4px; text-align: center; border-radius: 4px;">
            <div style="font-size: 7.5pt; font-weight: bold; color: #1a1a1a; margin-bottom: 2px;">أحمد مبروك</div>
        ...
        <div style="border: 1px dashed #cbd5e1; padding: 4px; text-align: center; border-radius: 4px;">
            <div style="font-size: 7.5pt; font-weight: bold; color: #1a1a1a; margin-bottom: 2px;">محمد مبروك</div>
            <div style="height: 8mm; border-bottom: 1.2px solid #64748b; margin-bottom: 2px;"></div>
            <div style="font-size: 6.5pt; color: #64748b;">توقيع / أحرف أولى</div>
        </div>
        <div style="border: 1px dashed #cbd5e1; padding: 4px; text-align: center; border-radius: 4px;">
            <div style="font-size: 7.5pt; font-weight: bold; color: #1a1a1a; margin-bottom: 2px;">م.وليد حمودة</div>
            <div style="height: 8mm; border-bottom: 1.2px solid #64748b; margin-bottom: 2px;"></div>
            <div style="font-size: 6.5pt; color: #64748b;">توقيع / أحرف أولى</div>
        </div>
        <div style="border: 1px dashed #cbd5e1; padding: 4px; text-align: center; border-radius: 4px;">
...
<div style="display: grid; grid-template-columns: repeat(4, 1fr) 60px; gap: 8px; margin-top: 10px; border-top: 1.5px solid #1a1a1a; padding-top: 8px;">
    ...
    <div style="border: 1px dashed #cbd5e1; padding: 4px; text-align: center; border-radius: 4px;">
        <div style="font-size: 7.5pt; font-weight: bold; color: #ff9900; margin-bottom: 2px;">م.وليد حمودة</div>
        <div style="height: 10mm; border-bottom: 1.2px solid #64748b; margin-bottom: 2px;"></div>
        <div style="font-size: 7pt; color: #ff9900;">مدير التشغيل</div>
    </div>
    <div style="border: 1px dashed #cbd5e1; padding: 4px; text-align: center; border-radius: 4px;">
        <div style="font-size: 7.5pt; font-weight: bold; color: #800020; margin-bottom: 2px;">محمد مبروك</div>
        <div style="height: 10mm; border-bottom: 1.2px solid #64748b; margin-bottom: 2px;"></div>
...
1. <strong>السيد أحمد مبروك</strong> - مصري الجنسية، المقيم بالإمارات (شريك مؤسس وعام)<br>
2. <strong>السيد محمد مبروك</strong> - مصري الجنسية، المقيم بالدقهلية (شريك مؤسس ومدير مالي)<br>
...
<p>يقصد بالألفاظ التالية أينما وردت في هذا العقد المعاني المحددة لها: "الشركة" تعني شركة مارتديا للتجارة والتوزيع ذ.م.م. "الشركاء" هم الموقعون الأربعة مجتمعين. "صندوق التأسيس" يعني صندوق الـ CapEx الممول بالتساوي لتجهيز الفروع. "رأس مال التداول" يعني رأس مال شراء البضائع كاش البالغ 200,000 ج.م.</p>

<div class="legal-section-title" style="margin-top: 6px;">مادة 2: الأهلية القانونية وتأسيس الكيان</div>
<p>يقر الشركاء الأربعة بأهليتهم القانونية والشرعية والتعاقدية الكاملة لإبرام هذا الاتفاق وتأسيس الشركة وتحمل كافة الالتزامات المالية والمدنية الناشئة عن أعمالها التجارية واللوجستية بمستودع طوخ الأقلام ومستودع ميت خميس.</p>

<div class="legal-section-title" style="margin-top: 6px;">مادة 3: أغراض الشركة ونطاق النشاط التجاري</div>
<p>الغرض الرئيسي للشركة هو تجارة الجملة والتوزيع، التعبئة والتغليف، تشغيل المستودعات الذكية والمنصات السحابية لتوريد وتوصيل الأغذية والمشروبات والمنظفات ومستحضرات العناية للبقالات وسوبرماركت ومقاهي الدلتا والمحافظات الإقليمية بمصر.</p>
...
<div class="legal-section-title" style="margin-top: 6px;">مادة 5: موازنة التجهيز والـ CapEx المشترك المنفصل</div>
<p>اتفق الشركاء على تخصيص صندوق نفقات تأسيسية رأسمالية (CapEx) مستقل تماماً بقيمة <strong>60,000 ج.م</strong> (بواقع 15,000 ج.م لكل شريك بالتساوي) لشراء الحواسب، الكاميرات الذكية Tapo، قارئ الباركود، التراخيص السحابية، الأرفف والطبالي، ولا يجوز سحب أي مبالغ من كابيتال البضائع (200k ج.م) لهذه الأغراض.</p>

<div class="legal-section-title" style="margin-top: 6px;">مادة 6: السياسات المالية والتحكم المركزي الفوري</div>
<p>تخضع جميع التدفقات المالية لـ مارتديا لرقابة مالية مركزية صارمة، ويتعهد كافة الشركاء والنواب بتوريد المقبوضات كاش يومياً للخزينة المركزية أو الحساب البنكي المعتمد تحت إشراف وتدقيق المدير المالي السيد محمد مبروك.</p>
...
<p>تفتح الشركة حساباً جاريّاً رسمياً باسمها لدى أحد البنوك المصرية المعتمدة بالدقهلية، ويكون للمدير المالي محمد مبروك منفرداً حق التوقيع والسحب والإيداع وإبرام التحويلات البنكية للشركاء والموردين.</p>

<div class="legal-section-title" style="margin-top: 4px;">مادة 10: قواعد توزيع الأرباح والاحتياطي النظامي</div>
<p>توزع الأرباح التشغيلية الصافية للشركة بنسبة حصص الشركاء (25% لكل شريك) بعد اقتطاع احتياطي مالي نظامي بنسبة 10% من الأرباح لمواجهة الطوارئ، واستبقاء جزء تراكمي بنسبة 15% كأرباح محتجزة لتمويل تمدد فروع ميت خميس والإسماعيلية.</p>

<div class="legal-section-title" style="margin-top: 4px;">مادة 11: تخصيص وتوزيع الخسائر المالية وحماية الأصول</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 12: سلطات مجلس الإدارة المشترك والتصويت</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 13: المسائل المحفوظة والتي تتطلب الإجماع المطلق</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 14: التزامات وحقوق الشركاء المؤسسين والنواب الميدانيين</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 15: تضارب المصالح وحوكمة المعاملات التجارية</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 16: السرية المطلقة وحفظ وحماية قواعد بيانات المنصة</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 17: الملكية الفكرية لبراءات وتطبيق مارتديا</div>
...
doc_12_p3_body = """
<div class="legal-section-title" style="margin-top: 2px;">مادة 18: حيازة وحفظ الأصول وتجهيزات المستودعات الرأسمالية (CapEx)</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 19: قبول ودخول شركاء جدد للكيان اللوجستي</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 20: قواعد التنازل عن الحصص وانتقال الملكيات</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 21: التخارج الطوعي وتصفية الحصص النقدية وسداد الديون</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 22: الوفاة أو العجز الدائم أو الإفلاس لأحد الشركاء</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 23: بند عدم المنافسة وعدم استقطاب عملاء المنصة</div>
<p>يتعهد كل شريك ونوابهم الميدانيون بعدم تأسيس أو المشاركة في أي نشاط تجاري أو لوجستي منافس لشركة مارتديا بالدقهلية أو الدلتا طوال مدة شراكتهم ولمدة 3 سنوات لاحقة لتاريخ تخارجهم الفعلي، تحت طائلة الالتزام بشرط جزائي رادع مقداره 100,000 ج.م.</p>

<div class="legal-section-title" style="margin-top: 4px;">مادة 24: القانون الواجب التطبيق والاختصاص القضائي بالمحاكم المصرية</div>
...
<div class="legal-section-title" style="margin-top: 4px;">مادة 25: نسخ العقد ونفاذه الفعلي وتوقيع الشركاء الأربعة</div>
